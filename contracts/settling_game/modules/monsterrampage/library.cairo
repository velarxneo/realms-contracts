...
namespace MonsterRampage {
    ...
    func calculate_winner{
        ...
        // TO DO: To update defending army's health
    ...
    //      If monster win the battle, reduce (30% of base hp divide by squareroot(rarity))
    //          and further reduce (30% of base hp divide by squareroot(defence)) of base HP
    //          and further reduce (random number from 0 to 10)
    //      If monster lose the battle, reduce (60% of base hp divide by squareroot(rarity))
    //          and further reduce (60% of base hp divide by squareroot(defence)) of base HP
    //          and further reduce (random number from 0 to 10)
    //
